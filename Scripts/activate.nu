...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Development\Python\Working\flask\checkService'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Development\Python\Working\flask\checkService\Scripts\deactivate.nu'
